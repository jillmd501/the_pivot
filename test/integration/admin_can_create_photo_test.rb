...
class AdminCanCreatePhotoTest < ActionDispatch::IntegrationTest
  test 'admin can create a photo test' do
    ...
    assert current_path, admin_business_photo_path(business_id: @business.slug, id: @photo.id)
  end
  ...
  test 'admin can edit a photo test' do
    ...
    assert current_path, admin_business_photos_path(business_id: @business.slug)
  end
